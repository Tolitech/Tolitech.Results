...
public static partial class ResultGuardExtensions
{
    ...
    /// <param name="message">The custom error message. Defaults to null.</param>
    /// <returns>The <see cref="ResultGuard{T}"/> instance, allowing for method chaining.</returns>
    public static ResultGuard<DateTimeOffset?> ErrorIfFuture(this ResultGuard<DateTimeOffset?> guard, StatusCode statusCode = StatusCode.BadRequest, string? key = null, string? message = null)
    {
        ArgumentNullException.ThrowIfNull(guard);

        if (guard.Value is not null && guard.Value.Value > DateTimeOffset.Now)
        {
            string resourceMessage = message ?? Resources.DateTime.DateTimeResource.ErrorIfFuture;
            message = TransformMessage(guard, message, resourceMessage);
            AddError(guard, key, message, statusCode);
    ...
    /// <param name="message">The custom error message. Defaults to null.</param>
    /// <returns>The <see cref="ResultGuard{T}"/> instance, allowing for method chaining.</returns>
    public static ResultGuard<DateTimeOffset?> ErrorIfFutureUtc(this ResultGuard<DateTimeOffset?> guard, StatusCode statusCode = StatusCode.BadRequest, string? key = null, string? message = null)
    {
        ArgumentNullException.ThrowIfNull(guard);
    ...
    /// <param name="message">The optional error message (default is <c>null</c>).</param>
    /// <returns>The <see cref="ResultGuard{T}"/> instance, allowing for method chaining.</returns>
    public static ResultGuard<DateTimeOffset?> ErrorIfNotFuture(this ResultGuard<DateTimeOffset?> guard, StatusCode statusCode = StatusCode.BadRequest, string? key = null, string? message = null)
    {
        ArgumentNullException.ThrowIfNull(guard);
    ...
    /// <param name="message">The optional error message (default is <c>null</c>).</param>
    /// <returns>The <see cref="ResultGuard{T}"/> instance, allowing for method chaining.</returns>
    public static ResultGuard<DateTimeOffset?> ErrorIfNotFutureUtc(this ResultGuard<DateTimeOffset?> guard, StatusCode statusCode = StatusCode.BadRequest, string? key = null, string? message = null)
    {
        ArgumentNullException.ThrowIfNull(guard);
    ...
    /// <param name="message">The custom error message. Defaults to null.</param>
    /// <returns>The <see cref="ResultGuard{T}"/> instance, allowing for method chaining.</returns>
    public static ResultGuard<DateTimeOffset?> ErrorIfPast(this ResultGuard<DateTimeOffset?> guard, StatusCode statusCode = StatusCode.BadRequest, string? key = null, string? message = null)
    {
        ArgumentNullException.ThrowIfNull(guard);
    ...
    /// <param name="message">The custom error message. Defaults to null.</param>
    /// <returns>The <see cref="ResultGuard{T}"/> instance, allowing for method chaining.</returns>
    public static ResultGuard<DateTimeOffset?> ErrorIfPastUtc(this ResultGuard<DateTimeOffset?> guard, StatusCode statusCode = StatusCode.BadRequest, string? key = null, string? message = null)
    {
        ArgumentNullException.ThrowIfNull(guard);
    ...
    /// <param name="message">The optional error message (default is <c>null</c>).</param>
    /// <returns>The <see cref="ResultGuard{T}"/> instance, allowing for method chaining.</returns>
    public static ResultGuard<DateTimeOffset?> ErrorIfNotPast(this ResultGuard<DateTimeOffset?> guard, StatusCode statusCode = StatusCode.BadRequest, string? key = null, string? message = null)
    {
        ArgumentNullException.ThrowIfNull(guard);
    ...
    /// <param name="message">The optional error message (default is <c>null</c>).</param>
    /// <returns>The <see cref="ResultGuard{T}"/> instance, allowing for method chaining.</returns>
    public static ResultGuard<DateTimeOffset?> ErrorIfNotPastUtc(this ResultGuard<DateTimeOffset?> guard, StatusCode statusCode = StatusCode.BadRequest, string? key = null, string? message = null)
    {
        ArgumentNullException.ThrowIfNull(guard);
